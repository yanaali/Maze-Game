...
public class MazeLevelTwo extends JPanel implements KeyListener {
...
public static void main2(String[] args) {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(displayWin[9][9] == (newX == 9 && newY == 9) && !gameWon){
            gameWon = true;
            JOptionPane.showMessageDialog(null, "Congratulations, you completed the maze! Click 'OK' to go to the final level!");
             new MazeLevelThree().main3(null);
        }
